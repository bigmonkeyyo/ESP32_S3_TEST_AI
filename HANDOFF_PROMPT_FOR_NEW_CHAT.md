...
最近一次稳定验证：
- `build/18_touch.bin` 大小约 `0x191800`
- factory app 分区 `0x1f0000`
- 剩余约 `0x5e800`，约 19%
- 注意：这是 app 分区剩余，不是整颗 Flash 剩余。整颗 Flash 是 16MB，后续可以通过调整 `partitions-16MiB.csv` 扩大 app 分区。
